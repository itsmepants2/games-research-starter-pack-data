...
- **Ask it to quote rows rather than summarise them.** A model handed 923 rows in a chat window starts summarising, and summarising is where invented rows come from.
